...
print(dfall.columns)
print(pd.unique(dfall.values.ravel("K"))) 
...
Running Regressions & Accuracy Outputs
...
print('Depression LIN REG Variance Score: {}'.format(model_depression.score(dx_test,dy_test)))
print('Depression Random Forest R^2 Score: {}'.format(rf_depression.score(dx_test,dy_test)))
...
print('Anxiety LIN REG Variance Score: {}'.format(model_anxiety.score(ax_test,ay_test)))
print('Anxiety Random Forest R^2 Score: {}'.format(rf_anxiety.score(ax_test,ay_test)))
...
print('Isolation LIN REG Variance Score: {}'.format(model_isolation.score(ix_test,iy_test)))
print('Isolation Random Forest R^2 Score: {}'.format(rf_isolation.score(ix_test,iy_test)))
...
print('Insecurity LIN REG Variance Score: {}'.format(model_insecurity.score(fx_test,fy_test)))
print('Insecurity Random Forest R^2 Score: {}'.format(rf_insecurity.score(fx_test,fy_test)))
